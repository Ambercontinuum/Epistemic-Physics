...
Epistemic Physics was developed through an iterative collaboration between Amber Anson and AI tools. Anson directed the research and developed the core ideas and proposed invariants. The papers, mathematical exposition, and Lean formalization were drafted and revised through that collaboration, with each stage informing the others.
