...
the three conjectures are axiomatized with precise type signatures. All five components
...
verification. The conjectures are axiomatized using \texttt{axiom} declarations,
which assert claims with precise type signatures without proof---the correct
Lean~4 posture for open mathematical claims.
...
-- ===========================================================
-- CONJECTURES (axiomatized -- proof obligation open)
-- ===========================================================
...
axiom conjectureA_quantum_complexity_reduction
    ...
    (hcl : forall n, 0 < C_classical n)
    (hq  : forall n, 0 < C_quantum n) :
